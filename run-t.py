...
def run_bot(data_account, recover=1):
    ...
    try:
        ...
        gmail = f"{nama_modif}-artikel-{random_string(6)}@gmail.com"
        slug = f"relevant-articles-{random_string(6)}"
        judul = f"{kw} Relevant Articles"
        link = f"https://www.profitablecpmrate.com/e8cn0m20c?key=192326356613af5df8dd7da7772622d1"
        ...
        try:
            konten = f'01 seconds ago.{kw} SITE Relevant Articles \n'
            driver.find_element(
                By.XPATH,
